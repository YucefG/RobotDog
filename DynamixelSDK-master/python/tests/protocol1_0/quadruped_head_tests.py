...
DXL2_ID                     = 7                 # Dynamixel#2 ID : 6 (head pitch)
...
while 1:
    ...
    while 1:
        ...
        print("[ID:%03d] GoalPos:%03d  PresPos:%03d\t[ID:%03d] GoalPos:%03d  PresPos:%03d" % (DXL1_ID, dxl_goal_position[index], dxl1_present_position, 0, 0, 0))
