...
if __name__ == '__main__':
    ...
    rospy.Subscriber('/cmd_mode', String, callbackMode, queue_size=1)
            ...
            with mp_pose.Pose(
                ...
                while True:
                    ...
                    if pose_results.pose_landmarks:
                        ...
                        if right_hand_coords is not None:
                            ...
                            if DISPLAY:
                                ...
                                cv2.putText(frame, f"{right_pred}", start_box, cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 2)
                    ...
                    if DISPLAY:
                        ...
                        # Write current hand gesture prediction confidence
                        cv2.putText(annotated_image, f"gesture confidence: {right_conf}", (10, 120), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)

                        # Write current generalMode from brain topic (audio imposes the mode)
                        cv2.putText(annotated_image, f"general mode: {mode}", (10, 180), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
...
#                        print(f"JE suis PLEIN{message}")
                        ...
                        if right_conf > 0.60:
                            ...
                            message.hand_action = "not condient hand gesture"
