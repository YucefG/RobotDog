...
class LowState(genpy.Message):
  _md5sum = "7f31131843c4b4618b684adc40faa091"
...
"""
  __slots__ = ['levelFlag','commVersion','robotID','SN','bandWidth','imu','motorState','bms','footForce','footForceEst','tick','wirelessRemote','reserve','crc','eeForceRaw','eeForce','position','velocity','velocity_w','cheat']
  _slot_types = ['uint8','uint16','uint16','uint32','uint8','unitree_legged_msgs/IMU','unitree_legged_msgs/MotorState[20]','unitree_legged_msgs/BmsState','int16[4]','int16[4]','uint32','uint8[40]','uint32','uint32','unitree_legged_msgs/Cartesian[4]','unitree_legged_msgs/Cartesian[4]','unitree_legged_msgs/Cartesian','unitree_legged_msgs/Cartesian','unitree_legged_msgs/Cartesian','unitree_legged_msgs/CheaterState']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       levelFlag,commVersion,robotID,SN,bandWidth,imu,motorState,bms,footForce,footForceEst,tick,wirelessRemote,reserve,crc,eeForceRaw,eeForce,position,velocity,velocity_w,cheat
    ...
    if args or kwds:
      ...
      if self.cheat is None:
        self.cheat = unitree_legged_msgs.msg.CheaterState()
    else:
      self.levelFlag = 0
      self.commVersion = 0
      self.robotID = 0
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_4f().pack(*self.cheat.orientation))
      buff.write(_get_struct_3f().pack(*self.cheat.position))
      buff.write(_get_struct_3f().pack(*self.cheat.vBody))
      buff.write(_get_struct_3f().pack(*self.cheat.vWorld))
      buff.write(_get_struct_3f().pack(*self.cheat.omegaBody))
      buff.write(_get_struct_3f().pack(*self.cheat.acceleration))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.cheat.orientation = _get_struct_4f().unpack(str[start:end])
      start = end
      end += 12
      self.cheat.position = _get_struct_3f().unpack(str[start:end])
      start = end
      end += 12
      self.cheat.vBody = _get_struct_3f().unpack(str[start:end])
      start = end
      end += 12
      self.cheat.vWorld = _get_struct_3f().unpack(str[start:end])
      start = end
      end += 12
      self.cheat.omegaBody = _get_struct_3f().unpack(str[start:end])
      start = end
      end += 12
      self.cheat.acceleration = _get_struct_3f().unpack(str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_9f().pack(_x.position.x, _x.position.y, _x.position.z, _x.velocity.x, _x.velocity.y, _x.velocity.z, _x.velocity_w.x, _x.velocity_w.y, _x.velocity_w.z))
      buff.write(self.cheat.orientation.tostring())
      buff.write(self.cheat.position.tostring())
      buff.write(self.cheat.vBody.tostring())
      buff.write(self.cheat.vWorld.tostring())
      buff.write(self.cheat.omegaBody.tostring())
      buff.write(self.cheat.acceleration.tostring())
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      self.cheat.orientation = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=4)
      start = end
      end += 12
      self.cheat.position = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=3)
      start = end
      end += 12
      self.cheat.vBody = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=3)
      start = end
      end += 12
      self.cheat.vWorld = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=3)
      start = end
      end += 12
      self.cheat.omegaBody = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=3)
      start = end
      end += 12
      self.cheat.acceleration = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=3)
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e)  # most likely buffer underfill
