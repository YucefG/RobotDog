...
struct LowState_
{
  ...
  _velocity_w_type velocity_w;
   ...
   typedef  ::unitree_legged_msgs::CheaterState_<ContainerAllocator>  _cheat_type;
  _cheat_type cheat;
...
struct MD5Sum< ::unitree_legged_msgs::LowState_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x7f31131843c4b461ULL;
  static const uint64_t static_value2 = 0x8b684adc40faa091ULL;
};
...
struct Printer< ::unitree_legged_msgs::LowState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::unitree_legged_msgs::LowState_<ContainerAllocator>& v)
  {
    ...
    s << indent << "cheat: ";
    s << std::endl;
    Printer< ::unitree_legged_msgs::CheaterState_<ContainerAllocator> >::stream(s, indent + "  ", v.cheat);
  }
};
