...
class LowState {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('cheat')) {
        this.cheat = initObj.cheat
      }
      else {
        this.cheat = new CheaterState();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [cheat]
    bufferOffset = CheaterState.serialize(obj.cheat, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [cheat]
    data.cheat = CheaterState.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static md5sum() {
    ...
    return '7f31131843c4b4618b684adc40faa091';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.cheat !== undefined) {
      resolved.cheat = CheaterState.Resolve(msg.cheat)
    }
    else {
      resolved.cheat = new CheaterState()
    }
