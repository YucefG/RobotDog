...
(cl:defclass <LowState> (roslisp-msg-protocol:ros-message)
  ((levelFlag
   ...
   (cheat
    :reader cheat
    :initarg :cheat
    :type unitree_legged_msgs-msg:CheaterState
    :initform (cl:make-instance 'unitree_legged_msgs-msg:CheaterState)))
)
...
(cl:ensure-generic-function 'cheat-val :lambda-list '(m))
(cl:defmethod cheat-val ((m <LowState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader unitree_legged_msgs-msg:cheat-val is deprecated.  Use unitree_legged_msgs-msg:cheat instead.")
  (cheat m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <LowState>) ostream)
  ...
  (roslisp-msg-protocol:serialize (cl:slot-value msg 'cheat) ostream)
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <LowState>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'cheat) istream)
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<LowState>)))
  ...
  "7f31131843c4b4618b684adc40faa091")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'LowState)))
  "Returns md5sum for a message object of type 'LowState"
  "7f31131843c4b4618b684adc40faa091")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <LowState>))
  (cl:+ 0
     ...
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'cheat))
))
