...
(defsystem "unitree_legged_msgs-msg"
  ...
  :components ((:file "_package")
    (:file "BmsCmd" :depends-on ("_package_BmsCmd"))
    (:file "_package_BmsCmd" :depends-on ("_package"))
    (:file "BmsState" :depends-on ("_package_BmsState"))
    (:file "_package_BmsState" :depends-on ("_package"))
    (:file "Cartesian" :depends-on ("_package_Cartesian"))
    (:file "_package_Cartesian" :depends-on ("_package"))
    (:file "CheaterState" :depends-on ("_package_CheaterState"))
    (:file "_package_CheaterState" :depends-on ("_package"))
