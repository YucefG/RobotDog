...
DEVICE = 32 #check this before in a terminal by executing "python3 search_auido_devices.py"
CHANNELS = 3
RATE = 16000
...
if __name__ == '__main__':
    ...
    it = 0
    n_samples = 12000 # 0.5s - will also put a delay of 0.5s (2hz)
    ...
    while(True):
        ...
        if it > 5:
           ...
           # keyword = "testing"
            ...
            if label[max] > 0.93 or (id2label[str(max)]=="follow" and label[max] > 0.92):
